...
datafile_train = "wikitext-2.train_text_document" # txt file or binidx file
datafile_valid = "enwik8/valid.txt"
datafile_test = "enwik8/test.txt"
...
train_dataset = Dataset(MMapIndexedDataset(datafile_train), 100, epoch_length_fixed) #use it when you use binidx files
...
if __name__ == '__main__':
    ...
    model = GPT(GPTConfig(train_dataset.vocab_size, ctx_len, model_type=model_type,
