...
record_file = open("spiketest.txt", 'a')
record_file.write(f"Device, {args.RUN_DEVICE}\n")
record_file.write(f"Context, {context}\n\n")
record_file.write("Processing Time, Generation Time\n")
...
for TRIAL in range(1 if DEBUG_DEBUG else NUM_TRIALS):
    ...
    record_file.write(f"{round(time_slot['preprocess'], 2)}, {round(time_slot['total']-time_slot['preprocess'], 2)}\n")
